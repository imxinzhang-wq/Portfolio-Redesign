          ...
          return (
            ...
            >
              <Link href={`/project/${project.id}`} className="block group">
                <div className="w-full aspect-square overflow-hidden rounded-[32px] bg-white/5 mb-10">
                  <img
                    src={project.image}
                    alt={project.title}
                ...
                <p className={`text-base text-white/70 font-light leading-[1.7] max-w-md ${alignRight ? 'md:ml-auto' : ''}`}>
                  {project.description}
                </p>
              </Link>
            </motion.div>
...
function About() {
  return (
    <section id="about" data-bg-color={SECTION_BG.canvas} className="py-60 px-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12">
            <div className="space-y-4">
              <h3 className="eyebrow font-bold text-foreground/40">Outside of work</h3>
...
function Footer() {
  return (
    <footer id="contact" data-bg-color={SECTION_BG.canvas} className="py-40 px-6 relative">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        <div className="text-center md:text-left">
          <p className="eyebrow font-bold text-foreground/40 mb-2">Say hello</p>
          <a href="mailto:about.dala@gmail.com" className="text-2xl font-display text-foreground hover:opacity-50 transition-opacity" data-testid="link-email">
            about.dala@gmail.com
          </a>
        </div>
        <div className="flex gap-8 eyebrow font-bold text-foreground/40">
          <a href="https://www.linkedin.com/in/imxinzhang/" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors">LinkedIn</a>
        </div>
      </div>
    </footer>
  );

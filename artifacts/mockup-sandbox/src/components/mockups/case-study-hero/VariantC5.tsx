...
export function VariantC5() {
  return (
    <div className="min-h-screen bg-[#f5f0e6] pt-32 pb-20 px-6 md:px-12 flex flex-col">
      {/* Container with a strict max-width for optimal reading measure */}
      <div className="max-w-[1200px] mx-auto w-full">
        
        {/* Massive Title */}
        <h1 className="text-[4rem] md:text-[6.5rem] lg:text-[8.5rem] font-display font-medium tracking-[-0.04em] mb-14 leading-[0.9] text-[#1a1918]">
          YT Shopping<br />Collections
        </h1>
        
        {/* Crisp Hairline Divider */}
        <div className="h-px w-full bg-[#1a1918]/15 mb-10" />
        
        {/* Content Split: 3-column / 9-column ratio */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-4 lg:col-span-3 flex flex-col gap-12">
            ...
            {/* Meta Block 1 */}
            <div>
              <h4 className="text-[10px] font-sans uppercase tracking-[0.2em] text-[#1a1918]/40 mb-4 font-bold">
                Platform & Year
              </h4>
          ...
          <div className="md:col-span-8 lg:col-span-9">
            ...
            <p className="text-[1.75rem] md:text-[2.25rem] lg:text-[2.75rem] font-sans font-light leading-[1.35] text-[#1a1918] tracking-[-0.01em] max-w-[35ch]">
